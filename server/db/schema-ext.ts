...
export const APIFOOTBALL_COLUMNS_SQL = `
ALTER TABLE matches ADD COLUMN IF NOT EXISTS apifootball_fixture_id TEXT;
ALTER TABLE matches ADD COLUMN IF NOT EXISTS live_status_short TEXT;
