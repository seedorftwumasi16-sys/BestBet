...
export const heroSlides = [
  {
    ...
    subtitle: "The biggest football event in the world is coming. Bet on every match live only on BestBet.",
    cta: "Bet Now",
    badge: "WORLD CUP",
  ...
  {
    id: "h2",
    title: "Road to 2026 — Qualifiers Live",
    subtitle: "Bet on World Cup qualifiers and international friendlies with boosted in-play odds on BestBet.",
    cta: "Bet Now",
    badge: "LIVE",
    href: "/sports/football?league=4429",
  ...
  {
    id: "h3",
    title: "World Cup Welcome Bonus",
    subtitle: "Double your first deposit up to GH₵ 500.00 and bet on every World Cup 2026 match.",
    cta: "Bet Now",
    badge: "NEW",
    href: "/register",
